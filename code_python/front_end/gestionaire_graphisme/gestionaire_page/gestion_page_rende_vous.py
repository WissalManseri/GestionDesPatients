...
class gestion_page_rendez_vous:
    def __init__(self, la_page: Page, couleur_ligne, couleur_entete, police_2, police_3) -> None:
        ...
        x, y= self.__initialise(police_2, police_3)
    ...
    def __execute_fonction(self, indice):
        ...
        if(fonction != None):
            fonction() 
    def __initialise(self, police_2, police_3):
        ...
        x= 0
        y=10
        self.__id_titre= self.__feuille.create_text(x,  y, text="RENDEZ-VOUS", font=police_2, anchor="nw")  
        #--------------------------------------------------------------------------
    ...
    def __cree_page_info(self, x, y, police_3, couleur_entete, couleur_ligne)  :
        ...
        self.__page_information= gestion_page_tableau(self.__feuille, x, y, [ "Nom du médecin", "Date", "Heure","Raison"], police_3, couleur_entete, couleur_ligne)    
    ...
    def __cree_bouton_ajout(self, y, couleur_ligne, police_3):
        ...
        bout_ajout= fonction_creation_elt_page.cree_bouton(self.__feuille, x, y, larg_bout, haut_bout, [self.__id_bouton], couleur_ligne, "Ajouter un rendez-vous", police_3)
        x= self.__feuille.bbox(self.__id_bouton)[2]+10
        bout_suppression = fonction_creation_elt_page.cree_bouton(self.__feuille, x, y, larg_bout, haut_bout, [self.__id_bouton], couleur_ligne, "Supprimer un rendez-vous", police_3)
